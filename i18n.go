...
var messages = map[string]map[string]string{
	"de": {
		...
		"size_m":              "Mittel",
		"size_l":              "Breit",
		"card_style":          "Kartenform",
		"cards_thumbs":        "Mit Vorschau",
		"cards_compact":       "Kompakt",
		"cards_tile":          "Kachel",
		"theme":               "Design",
		"theme_auto":          "Wie das System",
		"theme_light":         "Hell",
		"theme_dark":          "Dunkel",
		"theme_dashy_group":   "Dashy-Paletten",
		"icon":                "Symbol",
		"icon_optional":       "optional, sonst das Favicon",
		"icon_placeholder":    "z. B. sh-jellyfin, mdi-home, 🚀",
		"choose":              "Wählen",
		"choose_icon":         "Symbol wählen",
		"icon_dialog_sub":     "Sammlung wählen, dann tippen. Die Symbole werden einmal geholt und danach lokal ausgeliefert.",
		"icon_search":         "Symbol suchen …",
		"icon_searching":      "Suche läuft …",
		"icon_no_matches":     "Nichts gefunden.",
		"icon_failed":         "Die Symbolliste konnte nicht geladen werden.",
		"icon_use_favicon":    "Favicon verwenden",
		"collapse":            "Einklappen",
		"expand":              "Ausklappen",
	...
	"en": {
		...
		"cards_thumbs":        "With preview",
		"cards_compact":       "Compact",
		"cards_tile":          "Tile",
		"theme":               "Theme",
		"theme_auto":          "Match system",
		"theme_light":         "Light",
		"theme_dark":          "Dark",
		"theme_dashy_group":   "Dashy palettes",
		"icon":                "Icon",
		"icon_optional":       "optional, otherwise the favicon",
		"icon_placeholder":    "e.g. sh-jellyfin, mdi-home, 🚀",
		"choose":              "Choose",
		"choose_icon":         "Choose icon",
		"icon_dialog_sub":     "Pick a collection, then type. Icons are fetched once and served locally afterwards.",
		"icon_search":         "Search icons …",
		"icon_searching":      "Searching …",
		"icon_no_matches":     "Nothing found.",
		"icon_failed":         "The icon list could not be loaded.",
		"icon_use_favicon":    "Use favicon",
		"collapse":            "Collapse",
		"expand":              "Expand",
